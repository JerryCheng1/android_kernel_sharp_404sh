...
/* [WLAN][SHARP] 2015.03.24 Switching NV files Start */
static struct cnss_fw_files FW_FILES_QCA6174_FW_3_0_EXTERNAL = {
"qwlan30.bin", "exwlan30.bin", "otp30.bin", "utf30.bin",
"utfbd30.bin", "epping30.bin", "evicted30.bin"};
/* [WLAN][SHARP] 2015.03.24 Switching NV files End */
...
#else
					u32 target_type, u32 target_version, int is_internal)
#endif
/* [WLAN][SHARP] 2015.03.24 Switching NV files End */
{
	if (!pfw_files)
...
/* [WLAN][SHARP] 2015.03.24 Switching NV files Start */
		...
		if(is_internal){
			...
			memcpy(pfw_files, &FW_FILES_QCA6174_FW_3_0_EXTERNAL, sizeof(*pfw_files));
		}
#endif
/* [WLAN][SHARP] 2015.03.24 Switching NV files End */
		break;
